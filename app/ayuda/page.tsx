...
export default function AyudaPage() {
  return (
    <PageShell
      ...
      title="Orientación y soporte por zona"
      description="Encuentra apoyo según el tipo de duda y comunica tu situación al responsable que corresponda."
    >
      <section className="space-y-6">
        <SectionHeading
          eyebrow="Atención por tema"
          title="Tipos de ayuda disponibles"
          description="La atención está organizada para responder con claridad a las necesidades más frecuentes del proceso."
        />
      ...
      <section className="mt-12 space-y-6">
        <SectionHeading
          eyebrow="Contactos por zona"
          title="Directorio de responsables"
          description="La Zona Este aparece priorizada, pero también se incluyen referencias de otras zonas y del departamento nacional para dudas o aclaraciones."
        />
